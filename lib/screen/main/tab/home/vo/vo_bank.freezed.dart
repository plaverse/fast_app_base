...
abstract class $BankCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String logoImagePath});
}
...
class _$_Bank implements _Bank {
  _$_Bank(this.name, this.logoImagePath);
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, logoImagePath);
...
abstract class _Bank implements Bank {
  factory _Bank(final String name, final String logoImagePath) = _$_Bank;
